		...
		for (Object object : message) {
			if (object instanceof ChatColor) {
				...
				for (int templength = temp.length(); templength > 0; templength = temp
					...
					lastspace = lastspace > temp.length() ? temp.length()
							: lastspace;
